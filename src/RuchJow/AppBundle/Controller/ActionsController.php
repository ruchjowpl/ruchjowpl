...
class ActionsController extends ModelController
{
     ...
     * @return Response
     *
     * @Route("/ajax/organise_event", name="app_ajax_organise_event", options={"expose"=true})
     * @Method("POST")
     */
     ...
     * @return Response
     *
     * @Route("/ajax/organise_referendum_point", name="app_ajax_organise_referendum_point", options={"expose"=true})
     * @Method("POST")
     */
...
//        }
     ...
     * @return Response
     *
     * @Route("/ajax/distribute_leaflets", name="app_ajax_distribute_leaflets", options={"expose"=true})
     * @Method("POST")
     */
