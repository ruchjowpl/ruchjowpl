                ...
                ->arrayNode('validation')
                    ...
                    ->children()
                        ...
                        ->arrayNode('street')
                            ...
                            ->children()
                                ->scalarNode('pattern')
                                    ->defaultValue('/^([A-ZĄĆĘŁŃÓŚŹŻ]|[a-ząćęłńóśźż]|[.0-9_\-+()*&%$#@!?,;:"]){3,}( ?([A-ZĄĆĘŁŃÓŚŹŻ]|[a-ząćęłńóśźż]|[ .0-9_\-+()*&%$#@!?,;:"]))*$/')
                                ->end()
                                ->scalarNode('pattern_error')
                                    ->defaultValue('Street must contain only letters and special characters . 0 - 9 _ - + = ( ) * & % $ # @ ! ? , ; : ". Also it must be at least three letters long.')
                                ->end()
                            ->end()
                        ->end()
                        ->arrayNode('house')
